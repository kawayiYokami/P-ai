...
async fn ide_chat_handle_jsonrpc_request(
    ...
    let result = match request.method.as_str() {
        ...
        "mcp_oauth_login" => ide_chat_mcp_oauth_login_for_web_settings(state, request.params).await,
        "mcp_oauth_cancel" => ide_chat_mcp_oauth_cancel_for_web_settings(state, request.params),
        "mcp_oauth_status" => ide_chat_mcp_oauth_status_for_web_settings(state, request.params),
        "mcp_oauth_clear_credentials" => ide_chat_mcp_oauth_clear_credentials_for_web_settings(state, request.params).await,
