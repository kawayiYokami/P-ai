...
fn main() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            list_transport_conversations,
            list_conversation_create_options,
            get_conversation_workspace_permission,
            ...
            save_conversation_section_order,
