      ...
      <template v-else>
        <div class="config-grid-auto-md">
          <div
            ...
            role="button"
            tabindex="0"
            class="rounded-box border border-base-300 bg-base-100 p-3.5 hover:border-primary/50 transition-all duration-150 cursor-pointer flex items-center justify-between gap-3 select-none active:scale-[0.99] group"
...
const providerPresets: ProviderPreset[] = [
  ...
  { id: "requesty", name: "Requesty", category: "openaiCompatible", urls: { auto: "https://router.requesty.ai/v1", openai: "https://router.requesty.ai/v1", openai_responses: "https://router.requesty.ai/v1" }, docsUrl: "https://docs.requesty.ai" },
